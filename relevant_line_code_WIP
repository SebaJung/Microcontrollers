...
void goForward() {                          // go forward default fast
  OCR0A = 0;
...
void leftDetect() {         // if left sensor on tape...

  OCR0A = 0;
  OCR0B = 0;             //  left slower than right
  OCR2A = 0;
  OCR2B = 200;

}

void rightDetect() {          // if right sensor on tape...

  OCR0A = 0;
  OCR0B = 200;             //  right slower than left
  OCR2A = 0;
  OCR2B = 0;
}


void goSlow() {          // if right sensor on tape...

  OCR0A = 0;
  OCR0B = 100;             //  right slower than left
  OCR2A = 0;
  OCR2B = 100;
}


void leftDetectSlow() {          // if right sensor on tape...
...
void rightDetectSlow() {          // if right sensor on tape...

  OCR0A = 0;
  OCR0B = 80;             //  right slower than left
  OCR2A = 0;
  OCR2B = 0;
}
